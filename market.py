...
def get_product_list(page, campaign_id, access_token):
    """ Получает список товаров из кампании на Яндекс Маркете.
        ...
        Args:
            page (str): страница c результатами.
            campaign_id (str): Идентификатор кампании.
            access_token (str): API-токен доступа продавца Яндекс Маркета.
        Returns:
            dict: Ответ список товаров.
    """
...
def update_stocks(stocks, campaign_id, access_token):
    """ Обновить остатки.
        ...
        Args:
            stocks(list): даннаые об остатках товаров
            campaign_id(str): ID кампании.
            access_token(str): Токен доступа к API.
        Return:
            dict: словарь с информацией об остатках товарах в каталоге
    """
    endpoint_url = "https://api.partner.market.yandex.ru/"
    headers = {
        "Content-Type": "application/json",
...
def update_price(prices, campaign_id, access_token):
    """ Обновить прайс.
        ...
        Return:
            ...
            операции.
        Raises:
            HTTPError: Если код ответа отличается от 200.
    """
    endpoint_url = "https://api.partner.market.yandex.ru/"
    headers = {
        "Content-Type": "application/json",
...
def create_prices(watch_remnants, offer_ids):
    """ Создать остатки товаров Яндекс маркета.
        ...
        На основании данных с сайта timeworld.ru заполняет данные с новыми
        ценами для Яндекс Маркета.
        Args:
            watch_remnants (list): Список словарей с информацией о товарах.
            offer_ids (list): Список артикулов товаров Яндекс Маркета.
        Returns:
...
async def upload_stocks(watch_remnants, campaign_id, market_token, warehouse_id):
    """ Загрузить количество товаров на Яндекс Маркет.
        ...
        полученными в watch_remnants данными.
        Формирует в отдельный спискок товары, которые в наличии.
        Args:
            watch_remnants (list): Список словарей с информацией о товарах.
            campaign_id(str): ID кампании.
            market_token (str): API-токен продавца Яндекс Маркета.
